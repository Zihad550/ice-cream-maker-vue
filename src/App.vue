...
.cherry {
  background: url(assets/cherry.png) center/cover no-repeat;
  width: 50px;
  height: 77px;
  z-index: 3;
  margin-bottom: -10px;
...
.question {
  background: url(assets/question.png) center/cover no-repeat;
  width: 48px;
  height: 48px;
  z-index: 3;
  margin-bottom: 25px;
...
/* debug purpose, remove in production */

.react:after {
  content: var(--contenti);
  color: var(--color);
  font-weight: bold;
  font-style: italic;
}
